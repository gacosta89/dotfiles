...
(defun spacemacs//react-fmt-before-save-hook ()
  ...
  ;;;###autoload
(defcustom node-modules-path-debug nil
  "Enable verbose output when non nil."
  :type 'boolean)

  ;;;###autoload
(defcustom node-modules-max-depth 20
  "Max depth to look for node_modules."
  :type 'integer)


(defun spacemacs//react-node-modules-to-path ()
...
Any path found is added to the `exec-path'."
  ...
  (let* ((default-dir (expand-file-name default-directory))
        ...
        (iterations node-modules-max-depth)
